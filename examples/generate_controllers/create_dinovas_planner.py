...
class Environment():
    ...
    def define_files_path(self) -> None:
        ...
        config_path = os.path.join('/home/tomas/repos/grasp_fabrics/examples/evaluation/single_agent', 'dinova_config_rgf_3obst.yaml')
...
def set_planner(robot_urdf_path, config_dict, degrees_of_freedom: int = 9):
    ...
    planner.concretize()
    controller_file = "fabrics_controller_3obst.cpp"
